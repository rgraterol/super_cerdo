                        ...
                        <div class="form-api">
                            <div class="row">
                                <div class="white-bg-red-border">
                                    ...
                                    <div class="col-xs-9">
                                        {!! Form::text('birthday', null, ['class'=>'form-control form-control-fix', 'id' => 'datepicker', 'required'=>'Campo Obligatorio']) !!}
                    ...
                    <div class="medallas-mobile">
                        <div class="medallas-mobile-content">
                            ...
                            <div class="friend-frame left-medalla">
                                ...
                                <div class="img-rounded friend-check " id="dc-check">
                                    <input type="radio" name="three" class="left-check" />
                            ...
                            <div class="friend-frame right-medalla">
                                ...
                                <div class="img-rounded friend-check " id="dr-check">
                                    <input type="radio" class="right-check" name="three" id="right-check" checked="true"/>
                                    <label class="font-check"></label>
                                </div>
                            </div>
        ...
        <div class ="lightBoxGallery" id="footer">
            <div class="row footer">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 costillas">
                    <ul>
                        <li><a href="img/lightbox/1-DETALLE-BARBECUE.png" title="" data-gallery="" ><img src="img/carousel_big/1-costillita-barbecue-on.png" class="img-responsive inline-block hvr-grow"></a></li>
                        <li><a href="img/lightbox/2-DETALLE-CHILENA.png" title="" data-gallery="" ><img src="img/carousel_big/2-costillitas-chilenas-on.png" class="img-responsive inline-block hvr-grow"></a></li>
                        <li><a href="img/lightbox/3-DETALLE-IBERICA.png" title="" data-gallery="" ><img src="img/carousel_big/3-costillitas-ibericas-on.png" class="img-responsive inline-block hvr-grow"></a></li>
                        <li><a href="img/lightbox/4-DETALLE-MEXICANA.png" title="" data-gallery="" ><img src="img/carousel_big/4-costillitas-mexicanas-on.png" class="img-responsive inline-block hvr-grow"></a></li>
                        <li><a href="img/lightbox/5-DETALLE-PERUANA.png" title="" data-gallery="" ><img src="img/carousel_big/5-costillitas-peruanas-on.png" class="img-responsive inline-block hvr-grow"></a></li>
                        <li><a href="img/lightbox/6-DETALLE-COSTILLAR-BBQ.png" title="" data-gallery="" ><img src="img/carousel_big/6-costillar-barbecue-on.png" class="img-responsive inline-block hvr-grow"></a></li>
                        <li><a href="img/lightbox/7-DETALLE-COSTILLAR-CHILENAS.png" title="" data-gallery="" ><img src="img/carousel_big/7-costillar-chileno-on.png" class="img-responsive inline-block hvr-grow"></a></li>
                    </ul>
